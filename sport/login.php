<?php
	...
	if(isset($_POST['ok']))
	{
		...
		$sql = mysql_query("SELECT username FROM sport_admin WHERE username='$username' and password='$password'") or die(mysql_error());
...
<html>
<head>
	<title>Clearance Application - Sport Admin Login</title>
	<meta charset="utf-8">
		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<h3 class="page-header">Sport Admin Login</h3>
