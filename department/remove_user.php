<?php
	...
	{
		$id = $_GET['id'];
		$s = mysql_query("UPDATE books SET status='1' WHERE id='$id' and status='0'") or die(mysql_error());
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">
			<h3 class="page-header">Remove Book Borrower</h3>
			<div class="page-body">
				<?php flash(); ?>
				<table class="table table-bordered">
					...
					<tbody>
						<?php
							$sql = mysql_query("SELECT * FROM books WHERE status='0' ORDER BY id DESC") or die(mysql_error());
							$sn = 0;
