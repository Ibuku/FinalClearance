...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">
			<h3 class="page-header">Cleared Applicant</h3>
			<div class="page-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
							$sql = mysql_query("SELECT * FROM application WHERE status='2'  ORDER BY id DESC") or die(mysql_error());
							$sn = 0;
						...
						<tr>
							...
							<td><?php echo date("M d, y",$rs['date_approved']); ?></td>
