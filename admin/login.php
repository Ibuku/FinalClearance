<?php
	...
	if(isset($_POST['ok']))
	{
		...
		$sql = mysql_query("SELECT username FROM admin WHERE username='$username' and password='$password'") or die(mysql_error());
...
<html>
<head>
	<title>Clearance Application - Admin Login</title>
	<meta charset="utf-8">
