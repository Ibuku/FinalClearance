<?php
	...
	if(isset($_POST['ok']))
	{
		...
		$in = mysql_query("INSERT INTO books VALUES('','$matric','$name','$date_borrowed','0','$price')") or die(mysql_error());
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-3">
			<h3 class="page-header">Library Admin Menu</h3>
			<ul class="list-group">
		...
		<div class="col-md-9">
			<h3 class="page-header">Borrower Record Portal</h3>
			<div class="page-body">
				...
				<?php flash(); ?>
					...
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" required="" placeholder="Book Name">
					</div>
